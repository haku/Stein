...
public class Main {
	...
	private static class CommandFactory implements Factory<Command> {
	...
	private static class DesuCommand implements Command, SessionAware, Runnable {
		...
		public void start (Environment env) throws IOException {
			...
			this.thread = new Thread(this, "Command"); // TODO better name.
			this.thread.start();
		}
